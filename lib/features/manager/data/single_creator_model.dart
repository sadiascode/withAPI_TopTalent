class SingleCreatorModel {
  ...
  factory SingleCreatorModel.fromJson(Map<String, dynamic> json) {
    return SingleCreatorModel(
      id: json['id'] ?? 0,
      ...
      last3Months: Last3Months.fromJson(
          (json['last_3_months'] as Map<String, dynamic>? ?? {})),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'total_coin': totalCoin.toString(),
      'total_hour': totalHour.toString(),
  ...
  @override
  String toString() {
    return 'CreatorModel(id: $id, username: $username, managerId: $managerId, totalDiamond: $totalDiamond, rank: $rank)';
  }
}
